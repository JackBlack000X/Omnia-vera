...
export const styles = StyleSheet.create({
  ...
  priorityRowWrap: { flexDirection: 'row', gap: 10 },
  priorityChip: {
    flex: 1,
    minWidth: 0,
    flexDirection: 'row',
  ...
  priorityChipMainActive: {
    backgroundColor: 'rgba(236, 72, 153, 0.16)',
  },
  priorityChipText: { color: '#dbe5f5', fontWeight: '800', fontSize: 12, flex: 1, textAlign: 'center' },
  ...
  chip: { paddingHorizontal: 14, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: 'transparent' },
  chipGhost: { backgroundColor: 'transparent', borderColor: '#334155' },
  chipGhostText: { color: '#e2e8f0', fontWeight: '700' },
